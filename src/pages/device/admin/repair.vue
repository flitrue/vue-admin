                ...
                >
                    ...
                    <el-table-column
                        ...
                        <template scope="scope">
                            <router-link :to="{name: 'personDetail',params: {id: scope.row.uid}}">{{scope.row.name}}</router-link>
                        </template>
                    </el-table-column>
...
<script type="text/javascript">
    import {getRepair,changeRepair} from "../../../widgets/Api"
    ...
    export default {
        ...
        methods: {
            ...
            handleSelect(item) {
                ...
                changeRepair({params: data}).then( ({data: {code, data, msg}}) => {
                    if(code == 0){
