...
<script type="text/javascript">
    ...
    import {deviceEdit,deviceDetail} from "../../widgets/Api"
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit(){
                ...
                deviceEdit(this.form).then( ({data: {code, data, msg}}) => {
                    if(code == 0){
                        this.$message({
                            type: "success",
                            message: msg
            ...
            getDetail(id){
                deviceDetail({params: {did: id}}).then( ({data: {code, data, msg}}) => {
                    if(code == 0){
                        ...
                        this.form.buyway = data.buyway;
                        this.form.price = data.price;
                        this.form.remarks = data.remarks;
                        this.category = data.category[0];
                        this.ue.ready( () => {
                            this.ue.setContent(this.form.remarks);
                        });
